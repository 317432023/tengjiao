 ...
 */  
public final class ZxingCodeTool {
    ...
    public static boolean encodeQRCodeImage(String content, String charset, String imagePath, int width, int height, String logoPath) {  
        ...
        try {  
            /*for version 3.4*/ //MatrixToImageWriter.writeToPath(bitMatrix, imagePath.substring(imagePath.lastIndexOf(".") + 1), new File(imagePath).toPath(), config);
    ...
    public static String decodeQRCodeImage(String path, String charset) {
        ...
        try {
            ...
            System.out.println("二维码图片[" + path + "]解析失败,堆栈轨迹如下");
            e.printStackTrace();
            return "";
        }
    }
